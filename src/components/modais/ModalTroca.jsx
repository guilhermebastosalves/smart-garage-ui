    ...
    return (
        <Modal show={show} onHide={onHide} backdrop="static" keyboard={false}>
            <Modal.Header closeButton>
                <Modal.Title>Registro de Trocas</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <Form className={cadastro ? "d-none" : ""} onSubmit={handleSubmit}>
                    <Form.Group>
                        <Form.Label htmlFor="cpfCnpj">Informe o CPF ou CNPJ do fornecedor.</Form.Label>
                        <Form.Control
                            id="cpfCnpj"
                            type="text"
                ...
                </Form>
                {
                    cadastro &&
                    <>
                        <p>Fornecedor não encontrado. Verifique o CPF/CNPJ ou cadastre um novo cliente.</p>
