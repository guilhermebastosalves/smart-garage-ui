        ...
        <>
            ...
            <div className="container mt-4 mb-5">
                ...
                <div className="row g-4">
                    ...
                    <div className="accordion" id="accordionDetalhesCompra">
                        <div className="accordion-item">
                            <h2 className="accordion-header">
                                <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#compraInfo">
                                    <i className="bi bi-info-circle-fill text-primary me-2"></i>
                                    Informações da Compra
                                </button>
                            </h2>
                            <div id="compraInfo" className="accordion-collapse collapse" data-bs-parent="#accordionDetalhesCompra">
                    ...
                    <div className="accordion" id="accordionFornecedor">
                        <div className="accordion-item">
                            <h2 className="accordion-header">
                                <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#fornecedorInfo">
                                    <i className="bi bi-person-fill me-2 text-primary"></i>
                                    Informações do Fornecedor
                                </button>
                            </h2>
                            <div id="fornecedorInfo" className="accordion-collapse collapse" data-bs-parent="#accordionFornecedor">
                                <div className="accordion-body">
                                    {cliente && (
                                        <ul className="list-group list-group-flush">
                                            <li className="list-group-item d-flex justify-content-between">
