    ...
    return (
        <>
            ...
            <div className="container">
                {/* <h1>Consignações</h1>
                <p>listagem consignações</p>
                <button className='btn btn-primary' onClick={() => setShowModal(true)}>+ Nova Consignacao</button>
                <select name="opcao" id="opcao" onChange={handleInputChangeOpcao}>
